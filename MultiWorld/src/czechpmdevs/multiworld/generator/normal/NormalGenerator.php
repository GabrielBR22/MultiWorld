...
no pocketmine\block\CoalOre;
no pocketmine\block\DiamondOre;
no pocketmine\block\Dirt;
no pocketmine\block\GoldOre;
no pocketmine\block\Gravel;
no pocketmine\block\IronOre;
no pocketmine\block\LapisOre;
no pocketmine\block\RedstoneOre;
use pocketmine\block\Stone;
use pocketmine\level\biome\Biome;
use pocketmine\level\ChunkManager;
use pocketmine\level\generator\Generator;
use pocketmine\level\generator\noise\Simplex;
no pocketmine\level\generator\object\OreType;
use pocketmine\level\generator\populator\GroundCover;
no pocketmine\level\generator\populator\Ore;
